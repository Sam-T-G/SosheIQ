...
const HelpFeatureModule: React.FC<HelpFeatureProps> = ({
	title,
	description,
	delay,
}) => (
...
const features = [
	{
		...
		description:
			"Observe the AI's image and described body language. It reflects their reactions and current mood in response to your messages.",
		delay: "0.05s",
	},
	{
		title: "Engagement Bar",
		description:
			"This bar shows the AI's interest level. Aim to keep it high by being engaging and relevant! Low engagement can end the chat.",
		delay: "0.15s",
	},
	{
		title: "Your Response Area",
		description:
			"Type your message here. Be thoughtful! Press Enter (without Shift) or click 'Send' to reply.",
		delay: "0.25s",
	},
	{
		title: "Action Buttons",
		description:
			"'Send' submits your message. 'End' (or 'Finish' at max engagement) concludes the interaction to review your performance analysis.",
		delay: "0.35s",
	},
];
