...
export const ChatMessageViewAIThoughtBubble: React.FC<ChatMessageViewAIThoughtBubbleProps> = ({ message }) => {
  if (!message.text || message.text.trim() === "") {
    return null; // Don't render if thoughts are empty
  }

  return (
    <div className="flex justify-start w-full opacity-0 animate-[fadeIn_0.5s_ease-out_forwards]" style={{ animationDelay: '0.1s' }}>
      <div
        className={`
