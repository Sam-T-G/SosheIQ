...
export const ConfirmEndInteractionDialog: React.FC<ConfirmEndInteractionDialogProps> = ({ isOpen, onConfirm, onCancel }) => {
  if (!isOpen) {
    return null;
  }
    ...
    >
      ...
      >
        <div className="flex justify-between items-center">
          <h2 id="confirm-dialog-title" className="text-2xl font-bold text-sky-400">
            End Interaction?
          </h2>
          <button
            onClick={onCancel}
        ...
        <p id="confirm-dialog-description" className="text-gray-300">
          Are you sure you want to end the current interaction and return to the home screen? Your progress in this session will be lost.
        </p>
