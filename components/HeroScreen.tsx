...
export const HeroScreen: React.FC<HeroScreenProps> = ({ onNavigate }) => {
  return (
    <div className="flex flex-col items-center justify-center text-center w-full max-w-3xl p-6 md:p-10">
      <SosheIQLogo
        className="h-20 md:h-28 w-auto mb-8 animate-[fadeInSlideUp_0.7s_ease-out_forwards]"
        style={{ animationDelay: '0.1s' }} // Uncommented and now functional
      />
      <p 
        className="text-xl md:text-2xl text-gray-300 mb-12 animate-[fadeInSlideUp_0.7s_ease-out_forwards]"
